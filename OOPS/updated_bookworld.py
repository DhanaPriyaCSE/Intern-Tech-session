...
scala = Book("Martin Odersky",61,"German")
java = Book("James Gosling",65,"Canadian")
c = Book("Dennis Ritche",79,"American")
c_plus_plus = Book("Bjarne Stroustrup",69,"Danish")
generic_java = Book(500,"Martin Odersky",61,"German")
books =[python,scala,c,java,c_plus_plus,generic_java]

python1 = Author("Guido van rossum",64,"Dutch")
scala1 = Author("Martin Odersky",61,"German")
java1 = Author("James Gosling",65,"Canadian")
c1 = Author("Dennis Ritche",79,"American")
c_plus_plus1 = Author("Bjarne Stroustrup",69,"Danish")
generic_java1 = Author("Martin Odersky",61,"German")

books1 =[python1,scala1,c1,java1,c_plus_plus1,generic_java1]
